...
VALUES ('会议通知','本周三下午两点会议室开会','普通','2024-02-03'),
       ...
       ('停电通知','2月18日下午8电停电，预计停电2小时','置顶','2024-02-11'),
       ('会议通知','明天下午两点会议室开会','普通','2024-02-18');
...
VALUES (34,'陈四','00000033','女','家事','img/female.png','2024-01-02','2024-01-03','请假同意'),
       ...
       (21,'何七','00000020','男','祭祖','img/male.png','2024-02-17','2024-02-17','请假申请'),
       (42,'黄一','00000042','女','跳槽','img/female.png','2024-02-14','','离职申请'),
       (19,'何五','00000018','男','养病','img/male.png','2024-02-20','','离职申请');
...
VALUES (5,'团队培训','培养团队协作','2024-03-01','待办'),
       (0,'专业培训','培训专业技能','2024-02-24','待办'),
       (2,'个人培训','培训个人能力','2024-01-02','结束'),
...
-- 添加数据
insert into tb_salary(user_id, salary, basic_salary, late_time, leave_early_time, absence_time, leave_time, date)
VALUES (1,5000,5000,0,0,0,0,'2024-01'),
       (1,7000,5000,0,0,0,0,'2024-02'),
       (1,6000,5000,0,0,0,0,'2024-03');
...
VALUES (1,'张一','img/female.png','女','00000000','迟到','2024-01-02'),
       (2,'张二','img/male.png','男','00000001','缺勤','2024-02-02'),
       (3,'张三','img/male.png','男','00000002','早退','2024-02-02');
